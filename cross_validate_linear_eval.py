...
if __name__ == "__main__":
    ...
    wandb_logger = WandbLogger(name=f'{opt.batch_size}-{opt.lr}-{opt.weight_decay}-{opt.num_epochs}', project=opt.wandb_projectname)  # For each distinct set of hyperparameters, use a different `name`.
