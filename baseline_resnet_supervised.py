...
if __name__ == "__main__":
    ...
    if opt.use_wandb:
        ...
        wandb_logger = WandbLogger(name=f'(antlia)-supervised_resnet-{opt.batch_size}-{opt.lr}-{opt.weight_decay}-{opt.max_epochs}', project=opt.wandb_projectname)  # For each distinct set of hyperparameters, use a different `name`.
